...
export const componentLists: { [key: string]: CardComponentTemplate } = {
  iconCell: cardComponentMaker(
    defineAsyncComponent(
      () => import("@/components/basicComponents/cell/icon/iconCell.vue")
    ),
    {
      name: {
        label: "标签",
  ...
  icon: cardComponentMaker(
    defineAsyncComponent(
      () => import("@/components/basicComponents/cell/icon/icon.vue")
    ),
    {
      name: {
        label: "图标名称",
  ...
  setting_editable: cardComponentMaker(
    defineAsyncComponent(
      () =>
        import(
          "@/components/basicComponents/grid/module/baseToolComponents/editable.vue"
        )
    ),
    {},
    {},
  ...
  elcard: cardComponentMaker(
    defineAsyncComponent(
      () => import("@/components/basicComponents/cell/info/infoCard.vue")
    ),
    {
      title: {
        label: "标题",
  ...
  iframe: cardComponentMaker(
    defineAsyncComponent(
      () => import("@/components/basicComponents/cell/info/iframe.vue")
    ),
    {
      url: {
        label: "网页链接",
  ...
  userLogin: cardComponentMaker(
    defineAsyncComponent(() => import("@/components/userInfo/login.vue")),
    {},
    {},
    {
      label: "userLogin",
  ...
  //     }
  // }),
  cardApiControler: cardComponentMaker(
    defineAsyncComponent(
      () =>
        import("@/components/basicComponents/cell/action/cardApiControler.vue")
    ),
    {},
    {},
    {
  ...
  DynamicIsland: cardComponentMaker(
    defineAsyncComponent(
      () => import("@/components/basicComponents/cell/info/DynamicIsland.vue")
    ),
    {
      info: {
        label: "信息（一般不支持手填）",
  ...
  infoFile: cardComponentMaker(
    defineAsyncComponent(
      () =>
        import("@/components/basicComponents/cell/info/infoFile/infoFile.vue")
    ),
    {},
    {},
    {
